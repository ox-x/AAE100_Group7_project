...
I am responsible for the code writing of Task 1 Step 2 in this project. Because I have learnt a little bit of python before but I don’t really know much 
about it, I sometimes have some problems when writing code. In the process of solving the problem, I tried to ask other groupmates, and they told me 
how to solve them in an appropriate way. In addition, in the process of solving problems, I also learned how to use AI to help write part of the code 
and let AI explain the meaning of a certain string of code. During our group discussion, all the groupmates changed from strangers to familiar ones. I 
also gradually dared to put forward problems I did not understand to everyone from fear of communication, and everyone was eager to help solve 
them. These experiences have made me realize the importance of teamwork. Without this team, it is impossible for me to complete this project by 
myself. 
